...
#ifndef FLIPFLOPLITESDK_SWIFT_H
#define FLIPFLOPLITESDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="FlipFlopLiteSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC15FlipFlopLiteSDK11ASUndefined")
...
SWIFT_CLASS("_TtC15FlipFlopLiteSDK5ASXML")
...
///   </li>
/// </ul>
SWIFT_CLASS("_TtC15FlipFlopLiteSDK13ASXMLDocument")
...
SWIFT_CLASS("_TtC15FlipFlopLiteSDK10AVRecorder")
...
SWIFT_CLASS("_TtC15FlipFlopLiteSDK11AudioEffect")
...
SWIFT_CLASS("_TtC15FlipFlopLiteSDK25DefaultAVRecorderDelegate")
...
@interface DefaultAVRecorderDelegate (SWIFT_EXTENSION(FlipFlopLiteSDK))
...
/// 화상회의 객체
SWIFT_CLASS("_TtC15FlipFlopLiteSDK12FFConference")
...
SWIFT_CLASS("_TtC15FlipFlopLiteSDK14FFLLiveManager")
...
SWIFT_CLASS("_TtC15FlipFlopLiteSDK13FFLLivePlayer")
...
SWIFT_CLASS("_TtC15FlipFlopLiteSDK9FFMessage")
...
@interface FFMessage (SWIFT_EXTENSION(FlipFlopLiteSDK))
@property (nonatomic, readonly, copy) NSString * _Nonnull description;
@end


SWIFT_CLASS("_TtC15FlipFlopLiteSDK13FFMessageMeta")
...
@interface FFMessageMeta (SWIFT_EXTENSION(FlipFlopLiteSDK))
@property (nonatomic, readonly, copy) NSString * _Nonnull description;
@end
...
SWIFT_CLASS("_TtC15FlipFlopLiteSDK9FFMyLives")
...
@interface FFMyLives (SWIFT_EXTENSION(FlipFlopLiteSDK))
@property (nonatomic, readonly, copy) NSString * _Nonnull description;
@end


/// hls, webrtc video player
SWIFT_CLASS("_TtC15FlipFlopLiteSDK8FFPlayer")
...
SWIFT_CLASS("_TtC15FlipFlopLiteSDK6FFStat")
...
@interface FFStat (SWIFT_EXTENSION(FlipFlopLiteSDK))
@property (nonatomic, readonly, copy) NSString * _Nonnull description;
@end


SWIFT_PROTOCOL("_TtP15FlipFlopLiteSDK14FFStreamConfig_")
...
SWIFT_CLASS("_TtC15FlipFlopLiteSDK13FFStreamEvent")
...
SWIFT_CLASS("_TtC15FlipFlopLiteSDK10FFStreamer")
...
SWIFT_CLASS("_TtC15FlipFlopLiteSDK16FFStreamerConfig")
...
SWIFT_CLASS("_TtC15FlipFlopLiteSDK10FFVideoEnd")
...
SWIFT_CLASS("_TtC15FlipFlopLiteSDK11FFVideoInfo")
...
@interface FFVideoInfo (SWIFT_EXTENSION(FlipFlopLiteSDK))
- (NSString * _Nonnull)getGoods SWIFT_WARN_UNUSED_RESULT;
@end


SWIFT_CLASS("_TtC15FlipFlopLiteSDK11FFVideoList")
...
SWIFT_CLASS("_TtC15FlipFlopLiteSDK17FFVideoListLoader")
...
/// FlipFlop API 클라이언트
SWIFT_CLASS("_TtC15FlipFlopLiteSDK8FlipFlop")
...
SWIFT_CLASS("_TtC15FlipFlopLiteSDK12FlipFlopLite")
...
SWIFT_CLASS("_TtC15FlipFlopLiteSDK8GLHKView")
...
@interface GLHKView (SWIFT_EXTENSION(FlipFlopLiteSDK)) <GLKViewDelegate>
- (void)glkView:(GLKView * _Nonnull)view drawInRect:(CGRect)rect;
@end

@class AVCaptureVideoPreviewLayer;

SWIFT_CLASS("_TtC15FlipFlopLiteSDK6HKView")
...
SWIFT_CLASS("_TtC15FlipFlopLiteSDK9HLSPlayer")
...
@interface HLSPlayer (SWIFT_EXTENSION(FlipFlopLiteSDK)) <AVPictureInPictureControllerDelegate>
@end


@interface HLSPlayer (SWIFT_EXTENSION(FlipFlopLiteSDK))
...
SWIFT_CLASS("_TtC15FlipFlopLiteSDK8MTHKView")
...
@interface MTHKView (SWIFT_EXTENSION(FlipFlopLiteSDK)) <MTKViewDelegate>
...
SWIFT_CLASS("_TtC15FlipFlopLiteSDK9NetSocket")
...
SWIFT_CLASS("_TtC15FlipFlopLiteSDK9NetClient")
...
SWIFT_CLASS("_TtC15FlipFlopLiteSDK10NetService")
...
@interface NetSocket (SWIFT_EXTENSION(FlipFlopLiteSDK)) <NSStreamDelegate>
- (void)stream:(NSStream * _Nonnull)aStream handleEvent:(NSStreamEvent)eventCode;
@end


/// The <code>NetStream</code> class is the foundation of a RTMPStream, HTTPStream.
SWIFT_CLASS("_TtC15FlipFlopLiteSDK9NetStream")
...
SWIFT_CLASS("_TtC15FlipFlopLiteSDK12PLAudioMixer")
...
SWIFT_CLASS("_TtC15FlipFlopLiteSDK10RTMPStream")
...
SWIFT_CLASS("_TtC15FlipFlopLiteSDK20ScreenCaptureSession")
...
SWIFT_PROTOCOL("_TtP15FlipFlopLiteSDK17SwiftyGifDelegate_")
...
SWIFT_CLASS("_TtC15FlipFlopLiteSDK11VideoEffect")
...
SWIFT_CLASS("_TtC15FlipFlopLiteSDK15VideoRoomPlugin")
...
/// WebRTC Player
SWIFT_CLASS("_TtC15FlipFlopLiteSDK12WebRTCPlayer")
...
SWIFT_CLASS("_TtC15FlipFlopLiteSDK14WebRTCStreamer")
